<template>
    ...
    <Modal :showModal="isModalOpen" @close="closeModal">
        <h1 class="text-xl font-bold mb-4">Product Qoshish</h1>
        <form class="w-96" id="form"  @submit="addGenerator">
            ...
            />
            <div id="div">
                <div class="flex justify-between items-center mb-2" @click="addElement">
    ...
    <Modal :showModal="isEditModalOpen" @close="closeEditModal">
        ...
        <form class="w-96" id="form" @submit="updateProduct">
            ...
            <div id="div" class="mt-2">
                <p class="block w-10 z-10 mb-2 cursor-pointer" @click="addElement">Qo'shimcha</p>
            </div>
            <button class="bg-blue-600 w-full text-white py-2 px-4 rounded-md hover:bg-blue-600">Submit</button>
        </form>
    </Modal>
