    ...
    <div v-if="categories.length > 0" class="mt-4">
        ...
        <div>
            <form @submit="addProduct">
                ...
                <button id="addProductBtn" class="float-right bg-blue-600 max-w-full w-56 text-white py-2 px-4 rounded-md hover:bg-blue-600">Qo'shish</button>
            </form>
        </div>
    </div>
</template>
...
<script setup>
    ...
    const addProduct = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`https://generator2.hypernova.uz/api/add-product`, data, {
                headers: {
            ...
            const res = await axios.put(`https://generator2.hypernova.uz/api/add-img/${response.data._id}`, formData, {
                headers: {
